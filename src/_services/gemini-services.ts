...
export const FURIA_KNOWLEDGE = [
    // ELENCO E STAFF 2025
    {
        ...
        answer: 'Elenco principal em 2025:  KSCERATO, yuurih,FalleN, Molodoy, Yekindar. Reservas: chelo, skullz. Coach: sidde',
        sources: [
            'https://furia.gg/team',
    ...
    },
    {
        ...
        answer: 'Até 2025, a FURIA ainda não venceu um Major de CS2. Seu melhor resultado foi semifinal no PGL Major Antwerp 2022.',
    ...
    // PATROCINADORES E FINANÇAS
    {
        ...
        answer: 'Principais patrocinadores: adidas, cruzeiro do sul virtual, pokerstars, redbull , lenovo e hellmans',
    ...
    // HISTÓRICO E CURIOSIDADES
    {
        ...
        answer: 'A maior conquista até 2025 foi o título da ESL Pro League Season 17 em 2023, onde derrotaram a Vitality na final por 3-1.',
        sources: [
            'https://liquipedia.net/counterstrike/ESL/Pro_League/Season_17',
        ],
    },
    {
        question: 'Quem é o dono da FURIA?',
        answer: 'A FURIA foi fundada por Jaime Pádua e é presidida por Cris Guedes desde 2022. Em 2024, recebeu investimento do grupo XP Inc.',
        sources: [
    ...
    // INFRAESTRUTURA
    {
        ...
        answer: 'A FURIA mantém sua gaming house em São Paulo (Vila Olímpia) e um centro de treinamento em Dallas (EUA) desde 2023.',
...
export function searchFuriaKnowledge(userQuestion: string): {
    ...
    const DEFAULT_RESPONSE = {
        answer: 'Não encontrei informações atualizadas sobre isso. Posso te ajudar com outro tópico sobre a FURIA?',
        sources: [],
    };
    ...
    for (const [keyword, mappedQuestion] of Object.entries(keywordMap)) {
        if (lowerQuestion.includes(keyword)) {
            const match = FURIA_KNOWLEDGE.find(
                (item) =>
                    item.question.toLowerCase() === mappedQuestion.toLowerCase()
            );
