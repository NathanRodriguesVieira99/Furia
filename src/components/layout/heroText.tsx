...
export const HeroText = () => {
    return (
        ...
        >
            ...
            >
                Esports no cenário competitivo de CS2 em 2025! Desde
                emocionantes clutches do KSCERATO até as estratégias ousadas do
                arT, nosso site é o lugar onde os fãs se conectam, celebram e
            ...
            >
                {' '}
                Aqui, você não só acompanha os melhores momentos do time, mas
                também descobre mais sobre seus jogadores favoritos!.
            </motion.p>
        </motion.div>
    );
};
